...
export default function MyPost() {
  ...
  console.log(
    JSON.parse(window.localStorage.getItem("profile")).result,
    "7777"
  );
  const userId =
    params.userId ||
  ...
  useEffect(() => {
    ...
    setProfil({
      avatar: avatar,
      name: "wang",
      intro: "my name is zidong, I like cats",
      totalLikeCount: 5,
      id: "12312321",
      location: "munich",
      gender: "male",
      ...
      <div className="userPageProfil">
        ...
        <div>
          ...
          <div style={{ color: "gray", fontSize: "12px" }}>
            id: {profil.id} | location: {profil.location}
          </div>
          ...
          <div>
            {profil.totalLikeCount} <span style={{ color: "gray" }}>likes</span>
          </div>
        </div>
      </div>
      <div>
