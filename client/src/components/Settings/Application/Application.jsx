        ...
        return (
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    {applicant.avatar ? (
                        <Avatar src={applicant.avatar} sx={{
                        ...
                        <Avatar sx={{
                            border: '0.1px solid gray', width: '80px',
                            height: '80px',
                        ...
                        }}>{applicant.name.charAt(0)}</Avatar>
                    )}
                ...
                <FeedbackMsg status={showFeedbackMsg} message='Successfully updated' severity='success' onClose={handelfeebackMsgClose} />
            </Box>
        );
    };
}
