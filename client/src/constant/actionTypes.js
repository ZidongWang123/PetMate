...
export const FETCH_ALL_CREATED_EVENT = "FETCH_ALL_CREATED_EVENT";
export const FETCH_EVENT_SORTING = "FETCH_EVENT_SORTING";

export const FETCH_BY_SEARCH_EVENT = "FETCH_BY_SEARCH_EVENT";
